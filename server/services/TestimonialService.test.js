...
test('Test of the TestimonialService getData() function to ensure that the correct testimonial data is being passed through.', async () => {
  ...
  expect(data).toStrictEqual([
    { name: 'Bryan', title: 'Not Bad', message: 'Could be better.' },
    {
      name: 'Jason',
    ...
    { name: 'Fred', title: 'Nice Work', message: 'Keep it up!' },
    { name: 'gfdgfdsgfdsg', title: 'gfdgfdfsdg', message: 'dfsgdffdsg' },
    { name: 'afdfsf', title: 'fdsgsgd', message: 'fdgfdgdsg' },
    { name: 'sadsad', title: 'sadsadsa', message: 'dsadsad' },
    {
      name: 'Awesome',
    ...
    },
    {
      ...
      title: 'Great Speaker',
      message:
        'I really enjoyed the speaker this month. Would love to hear another presentation.',
    },
  ]);
  console.log(data);
});
